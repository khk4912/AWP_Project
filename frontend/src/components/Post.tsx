    ...
    <article className='relative flex gap-3 border-b border-gray-100 px-4 py-5 transition-colors hover:bg-gray-50/50'>
      ...
      <div className='min-w-0 flex-1'>
        <header className='relative z-50 flex items-start justify-between gap-3'>
          ...
          {isOwnPost
            ? (
              <div ref={menuRef} className='relative z-[60] -mr-2 -mt-1'>
                <button
                  type='button'
                  aria-label='게시글 메뉴'
                ...
                {isMenuOpen && (
                  <div className='absolute right-0 top-9 z-[60] w-36 overflow-hidden rounded-lg border border-gray-200 bg-white py-1 shadow-lg'>
                    <Link
